...
public class ItemDTO {
    ...
    @NotBlank(groups = {Create.class, Update.class}, message =  "El Tipo del bien no puede estar vacío.")
    @Size(max = 100, groups = {Create.class, Update.class}, message = "El Tipo del bien no puede exceder los 100 caracteres.")
    private ItemType itemType;

    @NotBlank(groups = {Create.class, Update.class}, message = "La Marca del bien no puede estar vacía.")
    @Size(max = 100, groups = {Create.class, Update.class}, message = "La Marca del bien no puede exceder los 100 caracteres.")
    private Brand brand;

    @NotBlank(groups = {Create.class, Update.class}, message = "El Modelo del bien no puede estar vacía.")
    @Size(max = 100, groups = {Create.class, Update.class}, message = "El Modelo del bien no puede exceder los 100 caracteres.")
    ...
    @NotNull(groups = {ChangeStatus.class}, message = "El estado no puede estar vacio")
